    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-lg-4 mx-auto">
                <img src="uploads/images/{{$founders->image}}" width="100%">
            </div>
        </div>
        <div class="row">
            <?php
                                $title=$founders->name_en;
                                $details=$founders->bio_en;
                                $position=$founders->position_en;
                                if($_SESSION["lng"]=="ar"){
                                    $title=$founders->name_ar;
                                    $details=$founders->bio_ar;
                                    $position=$founders->position_ar;
                                }else if($_SESSION["lng"]=="fr"){
                                    $title=$founders->name_fr;
                                    $details=$founders->bio_fr;
                                    $position=$founders->position_fr;
                                }
