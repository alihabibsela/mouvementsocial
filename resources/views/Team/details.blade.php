    ...
    <div class="container">
        <div class="row">
            ...
            <div class="row">
                ...
                <img src="uploads/images/{{$MsTeam->image}}" width="100%">
            </div>
        </div>
        <?php
            $name=$MsTeam->name_en;
            $bio=$MsTeam->bio_en;
            $position=$MsTeam->position_en;
            if($_SESSION["lng"]=="ar"){
                $name=$MsTeam->name_ar;
                $bio=$MsTeam->bio_ar;
                $position=$MsTeam->position_ar;
            }else if($_SESSION["lng"]=="fr"){
                $name=$MsTeam->name_fr;
                $bio=$MsTeam->bio_fr;
                $position=$MsTeam->position_fr;
            }
        ...
        <div class="row">
            <div class="col-md-12 col-lg-8 mx-auto">
                <h3 class="blog-details__title"><?=$name?></h3>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 col-lg-8 mx-auto">
