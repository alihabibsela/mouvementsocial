...
<section class="event-pag pt-5" hidden>
    <div class="container container-w">
        <div class="col-md-12 col-lg-12">
            <div class="block-title">
                <h3><?=$_SESSION["lng"]=="ar"?"وظائف شاغرة":($_SESSION["lng"]=="fr"?"Postes vacants":"Job Vacancies")?></h3>
            </div><!-- /.block-title -->
        </div>
        <div class="event-grid JobList">
...
<section class="event-page pt-5 pb-5">
    <div class="container container-w">
        <div class="col-md-12 col-lg-12">
            <div class="block-title">
                <h3><?=$_SESSION["lng"]=="ar"?"  المناقصات":($_SESSION["lng"]=="fr"?"Appels d'offres":"Tenders")?></h3>
            </div><!-- /.block-title -->
        </div>
        <div class="event-grid CallsList">

        </div><!-- /.event-grid -->
        <ul class="list-unstyled post-pagination d-flex justify-content-center align-items-center CallsPagination">
            {{-- <li><a href="#"><i class="far fa-angle-left"></i></a></li>
            <li><a href="#">01</a></li>
            <li><a href="#">02</a></li>
            <li><a href="#">03</a></li>
