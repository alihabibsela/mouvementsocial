...
<section class="cause-details blog-details  pt-3 pb-5">
    <div class="container">
            ...
            <div class="col-md-8 col-12 mx-auto">
                <div class="row">
                        <div class="gallery-card selectedYear" style="{{$_SESSION["lng"]=="ar"?"text-align: right;":"text-align: left;"}} margin:18px">
                            <a class="custom-button" style="background-color: transparent; color:white;" href="{{url('/programs')}}/{{$programs->programs_category_id}}"><?=$_SESSION["lng"]=="ar"?"عودة":($_SESSION["lng"]=="fr"?"Dos":"Back")?></a>
                        </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-5 col-12" hidden>
                        ...
                        {{-- <div class="w-100" style="text-align: center; padding-top: 51px;">
                            <a class="custom-button" href="{{url('/donate')}}"><?=$_SESSION["lng"]=="ar"?"تبرع الآن":($_SESSION["lng"]=="fr"?"Faire un don maintenant":"Donate Now")?></a>
                        </div> --}}
                    </div>
                </div>
        ...
        <div class="row"  style="<?=empty($BeneficiariesCheck)?"display: none;":""?>">
            <div class="col-md-12 col-lg-8 mx-auto">
                <h3 class="blog-details__title"><?=$_SESSION["lng"]=="ar"?"المستفيدون":($_SESSION["lng"]=="fr"?"Les bénéficiaires":"Beneficiaries")?></h3>
            </div>
        </div>
