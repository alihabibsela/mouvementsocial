...
$records = Cms_general::select($condition);
...
<th></th>
	...
	?>
				<tr  id="<?php echo $cms_general->general_id;?>">
					...
					<td><?php echo substr($cms_general->site_title, 0, 100); if(strlen($cms_general->site_title) > 100) echo "...";  ?></td>
<td><?php echo substr($cms_general->email, 0, 100); if(strlen($cms_general->email) > 100) echo "...";  ?></td>
