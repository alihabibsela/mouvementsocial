...
$records = Cms_admin::select($condition);
...
<th></th>
	...
	?>
				<tr  id="<?php echo $cms_admin->admin_id;?>">
					...
					<td><?php echo substr($cms_admin->admin_name, 0, 100); if(strlen($cms_admin->admin_name) > 100) echo "...";  ?></td>
<td><?php echo substr($cms_admin->user_name, 0, 100); if(strlen($cms_admin->user_name) > 100) echo "...";  ?></td>
<td><?php echo substr($cms_admin->password, 0, 100); if(strlen($cms_admin->password) > 100) echo "...";  ?></td>
<td><?php echo substr($cms_admin->email, 0, 100); if(strlen($cms_admin->email) > 100) echo "...";  ?></td>
