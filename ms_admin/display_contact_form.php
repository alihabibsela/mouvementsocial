...
$offset = 0;
$page=$_REQUEST["page"];
$recordsCount = Contact_form::count($condition);
...
$records = Contact_form::select($condition);
?><div class="portlet box blue">
	<div class="portlet-title">
		<div class="caption">
				<i class="fa fa-globe"></i>CONTACT FORM MANAGEMENT
				<!--
...
<!-- <th></th> -->
	...
	?>
				<tr  id="<?php echo $contact_form->contact_form_id;?>">
					<!-- primary key -->
...
<td><?php echo substr(strip_tags($contact_form->name), 0, 30); if(strlen($contact_form->name) > 30) echo "...";  ?></td>
<td><?php echo substr(strip_tags($contact_form->email_address), 0, 30); if(strlen($contact_form->email_address) > 30) echo "...";  ?></td>
<td><?php echo substr(strip_tags($contact_form->phone), 0, 30); if(strlen($contact_form->phone) > 30) echo "...";  ?></td>
<td><?php echo substr(strip_tags($contact_form->subject), 0, 30); if(strlen($contact_form->subject) > 30) echo "...";  ?></td>
<td><?php echo substr(strip_tags($contact_form->message), 0, 30); if(strlen($contact_form->message) > 30) echo "...";  ?></td>

					<td>
						<a class="btn btn-xs green" href="edit_contact_form.php?id=<?php echo $contact_form->contact_form_id?>">
						View
						<i class="fa fa-eye"></i>
						</a>
					</td>
					<!-- <td>
						<a class="btn btn-xs red" href="javascript:deleteAjax('contact_form', '<?php echo $contact_form->contact_form_id;?>')">
