...
return $data;
}public static function save($id,  $site_title,  $email){
if($id == ""){
$query = "insert into cms_general set `site_title` = '$site_title' , `email` = '$email'  "; 
}else{
$query = "update cms_general set `site_title` = '$site_title' , `email` = '$email'  where general_id = $id"; 
