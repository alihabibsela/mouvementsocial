...
include 'config.php';
$id=$_REQUEST["id"];
$centers = Centers::selectById($id);
?>
<link href="css/css.css" rel="stylesheet" type="text/css" />
<script language="javascript" src="javascript/centers_validation.js"></script>
...
<div class="portlet box green">
	<div class="portlet-title">
		<div class="caption"><i class="fa fa-reorder"></i>Edit Centers</div>
	</div>
	<div class="portlet-body form">
	<form action="update_centers.php" method="post" enctype="multipart/form-data" name="frm" id="frm"  class="form-horizontal form-bordered" >
                <div class="tab-content">
                    <div id="home" class="tab-pane fade in active">
                        <div class="form-body">
                                    <input name="centers_id" type="hidden" value="<?php echo $centers->centers_id?>" />

                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Name ar</label>
                                        <div class="col-md-3">
                                            <input     name="name_ar" type="text"  class="form-control" id="name_ar" value="<?php echo stripslashes($centers->name_ar)?>" placeholder="Enter Name ar">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input     name="name_en" type="text"  class="form-control" id="name_en" value="<?php echo stripslashes($centers->name_en)?>" placeholder="Enter Name en">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input     name="name_fr" type="text"  class="form-control" id="name_fr" value="<?php echo stripslashes($centers->name_fr)?>" placeholder="Enter Name fr">
                                        </div>
                                    </div>
                                    ...
                                    <label class="col-md-3 control-label">Address ar</label>
                                        ...
                                        <?php
                                            ...
                                            $fck->Value = stripslashes($centers->address_ar);
                                    ...
                                    <label class="col-md-3 control-label">Address en</label>
                                        ...
                                        <?php
                                            ...
                                            $fck->BasePath = "fckeditor/";
                                            $fck->Value = stripslashes($centers->address_en);
                                            $fck->Config["EnterMode"] = "br";
                                            $fck->Create ();
                                            ?>
                                        </div>
                                    ...
                                    <label class="col-md-3 control-label">Address fr</label>
                                        ...
                                        <?php
                                            ...
                                            $fck->BasePath = "fckeditor/";
                                            $fck->Value = stripslashes($centers->address_fr);
                                            $fck->Config["EnterMode"] = "br";
                                            $fck->Create ();
                                            ?>
                                        </div>
                    ...
                    <label class="col-md-3 control-label">text ar</label>
                        ...
                        <?php
                            ...
                            $fck->BasePath = "fckeditor/";
                            $fck->Value = stripslashes($centers->text_ar);
                            $fck->Config["EnterMode"] = "br";
                            $fck->Create ();
                        ?>
                        </div>
                    ...
                    <label class="col-md-3 control-label">text en</label>
                        ...
                        <?php
                            ...
                            $fck->BasePath = "fckeditor/";
                            $fck->Value = stripslashes($centers->text_en);
                            $fck->Config["EnterMode"] = "br";
                            $fck->Create ();
                        ?>
                        </div>
                    ...
                    <label class="col-md-3 control-label">text fr</label>
                        ...
                        <?php
                            ...
                            $fck->BasePath = "fckeditor/";
                            $fck->Value = stripslashes($centers->text_fr);
                            $fck->Config["EnterMode"] = "br";
                            $fck->Create ();
                        ?>
                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input     name="phone" type="text"  class="form-control" id="phone" value="<?php echo stripslashes($centers->phone)?>" placeholder="Enter Phone">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input     name="fax" type="text"  class="form-control" id="fax" value="<?php echo stripslashes($centers->fax)?>" placeholder="Enter Fax">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input     name="email" type="text"  class="form-control" id="email" value="<?php echo stripslashes($centers->email)?>" placeholder="Enter Email">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input     name="orders" type="text"  class="form-control" id="orders" value="<?php echo stripslashes($centers->orders)?>" placeholder="Enter Orders">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            while($centers_type=mysqli_fetch_object($result)){
                                                if($centers_type->centers_type_id==$centers->type)
                                                    $sel="Selected";
                                                        else
                                                    $sel="";
                                                ?>
                                                <option value="<?php echo $centers_type->centers_type_id?>" <?php echo $sel?>><?php echo $centers_type->centers_type_en?></option>
                                            <?php }?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            while($area=mysqli_fetch_object($result)){
                                                if($area->area_id==$centers->area_id)
                                                    $sel="Selected";
                                                        else
                                                    $sel="";
                                                ?>
                                                <option value="<?php echo $area->area_id?>" <?php echo $sel?>><?php echo $area->name_en?></option>
                                            <?php }?>
                                            </select>
                                        </div>
                                    </div>
                    ...
                    <div id="menu1" class="tab-pane fade">
                        ...
                        <?php
                            $sql="select * from gallery_item where COALESCE(video,'')='' AND centers_id=$centers->centers_id";
                            $result=mysqli_query ($_SESSION["db_conn"], $sql);
                            while($ImageObj=mysqli_fetch_array($result)){?>
                                <div class="col-md-3 col-12 imageItem">
                                    <input type="hidden" class="ImageUrl" value="<?=$ImageObj["image"]?>">
                                    <div class="kt-avatar kt-avatar--outline" id="kt_apps_user_add_avatar" style="background-image: url(<?=$imagesPath.$ImageObj["image"]?>);">
                                        <a class="removeImage"><i class="fa fa-ban"></i></a>
                                        <!-- <img class="kt-avatar__holder MainImageItem" src="<?=$imagesPath.$ImageObj["image"]?>"> -->
                                        <input type="hidden" class="imageItemInput" value="<?=$ImageObj["image"]?>">
                                    </div>
                                </div>
                            <?php }?>
                            ...
                            while($ImageObj=mysqli_fetch_array($result)){?>
                                <div class="col-md-3 col-12 VideoItem">
                                    ...
                                    <div class="kt-avatar kt-avatar--outline" id="kt_apps_user_add_avatar" style="background-image: url(<?=$imagesPath.$ImageObj["image"]?>);">
                                        ...
                                        <!-- <img class="kt-avatar__holder MainImageItem" src="<?=$imagesPath.$ImageObj["image"]?>"> -->
                                        <input type="hidden" class="Itemimage" value="<?=$ImageObj["image"]?>">
                                        <input type="hidden" class="Itemnews_id" value="<?=$ImageObj["news_id"]?>">
                                        <input type="hidden" class="Itemvideo" value="<?=$ImageObj["video"]?>">
                                        <input type="hidden" class="imageorders" value="<?=$ImageObj["orders"]?>">
                                    </div>
                                </div>
                            <?php }?>
